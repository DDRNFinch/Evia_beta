...
function ready(){patchSelectors();if(!document.body.__eviaST0264CutoverObserved){document.body.__eviaST0264CutoverObserved=true;new MutationObserver(schedule).observe(document.body,{childList:true,subtree:true})}}
if(document.readyState==="loading")document.addEventListener("DOMContentLoaded",ready);else ready();
window.addEventListener("pageshow",ready);
window.EviaST0264PackCutover={packInstalled,patchSelectors};
})();